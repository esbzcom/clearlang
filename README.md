...
`clg.project.json` schema v1 also stores project metadata (`name`, `description`, `version`, `clg_version`, website/contact) and user-authored dependency requirements for `clg pkg lock`:
