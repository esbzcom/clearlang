...
#[test]
fn parse_release_defaults_accepts_schema_v2_shared_std_manifest() {
    let content = r#"{
  "schema_version": 2,
  "project": {
    "name": "example-app",
  ...
  "dependencies": [
    { "name": "acme::payments", "requirement": "^1.0.0" }
  ],
  "std": {
    "delivery": "shared",
    "packages": [
  ...
  "release_defaults": {
    ...
    assert_eq!(std.packages[0].package_id, "std::text");
...
#[test]
fn parse_release_defaults_accepts_schema_v2_std_eth_shared_std_manifest() {
    let content = r#"{
  "schema_version": 2,
  "project": {
    "name": "example-app",
  ...
  "release_defaults": {
    ...
    assert_eq!(std.delivery, "shared");
    assert_eq!(std.packages.len(), 1);
    assert_eq!(std.packages[0].package_id, "std::eth");
    assert_eq!(std.packages[0].version_requirement, "^1.2.0");
}

#[test]
fn parse_release_defaults_accepts_schema_v2_std_solana_shared_std_manifest() {
    let content = r#"{
  "schema_version": 2,
  "project": {
    "name": "example-app",
  ...
  "release_defaults": {
    ...
    assert_eq!(std.delivery, "shared");
    assert_eq!(std.packages.len(), 1);
    assert_eq!(std.packages[0].package_id, "std::solana");
    assert_eq!(std.packages[0].version_requirement, "^1.2.0");
}

#[test]
fn parse_release_defaults_accepts_schema_v2_std_cosmos_shared_std_manifest() {
    let content = r#"{
  "schema_version": 2,
  "project": {
    "name": "example-app",
  ...
  "release_defaults": {
    ...
    assert_eq!(std.delivery, "shared");
    assert_eq!(std.packages.len(), 1);
    assert_eq!(std.packages[0].package_id, "std::cosmos");
    assert_eq!(std.packages[0].version_requirement, "^1.2.0");
}
