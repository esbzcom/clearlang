...
#[test]
fn release_command_accepts_std_cosmos_shared_std_evidence_for_shared_manifest() {
    let tmp = tempdir().unwrap();
    let root = tmp.path().join("project");
    fs::create_dir_all(&root).expect("create root");
    ...
    write_shared_std_package_metadata_fixtures(
        ...
        &[SharedStdPackageFixture {
            ...
            version: "1.2.0",
            artifact_text: "wasm-cosmos",
            key_seed: 11,
            key_id: "std-publisher-ed25519-2027q1",
            signed_at: "2026-06-25T00:00:00Z",
            statement_digest: "sha256:ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff",
            statement_format: "in-toto-v1",
            abi_major: 1,
            abi_minor_min: 0,
            abi_minor_max: 0,
