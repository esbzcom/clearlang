...
use wasm_encoder::{
    ...
    Module, TypeSection, ValType, NameSection, NameMap, MemorySection, MemoryType,
    DataSection, ConstExpr, GlobalSection, GlobalType,
};
use lumi_ir::{BinOpIR, Function as IrFunction, Instr as IrInstr, Module as IrModule};
mod intrinsics { pub mod strings; }
use intrinsics::strings::{encode_intrinsic_str_len, encode_intrinsic_str_eq, encode_intrinsic_str_concat};
...
// AST const-eval path removed in Phase 5.4; IR→Wasm is the sole codegen path.
