use anyhow::Result;
use clg_ast::{BinOp, Expr, ParamKind, Span, Type, UnaryOp};
use std::collections::{HashMap, HashSet};

use super::super::{
    base_type, base_types_match, binding_compatible, find_resource_collection, is_resource_type,
    refinement_loss, substitute_type, type_contains_params, type_param_names, unify_type_params,
    AliasMap, BoundsMap, FnSig, LocalBinding, TraitEnv, TypeDefs, TypeSubst, RETURN_KEY,
};
use super::block::type_block;
use super::literals::{
    ensure_bool, ensure_int, int_literal_value, literal_can_coerce_unsigned,
    u64_literal_overflow, unsigned_literal_fits_value, unsigned_literal_range_error,
