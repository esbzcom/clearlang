...
pub(super) const BYTES_HEADER_LEN_OFFSET: u32 = 0;
pub(super) const BYTES_HEADER_DATA_OFFSET: u32 = 4;
...
pub(super) fn emit_bytes_len(ctx: &mut LowerCtx<'_>, ptr: Value) -> Value {
