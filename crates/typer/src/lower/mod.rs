use crate::check::{
    ...
    LocalBinding, StdTypeMap, TraitEnv, TypeDefs,
};
...
use layout::{
    array_layout, build_type_param_subst, collection_layout, enum_variant_info, map_entry_layout,
    std_type_info_for, std_type_info_for_module, struct_layout, tuple_layout,
};
