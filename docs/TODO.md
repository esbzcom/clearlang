...
- [ ] 25.2 Release workflow and proved-only UX simplification [Gate C]
  ...
  - [ ] 25.2.6 Add CLI simplification/deprecation pass: hide and remove flag-heavy legacy release path from primary docs/help and emit migration guidance to `clg release` (no compatibility aliases required pre-production).
