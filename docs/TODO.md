...
Milestone details are extracted to:
- [`docs/todo/milestone_25_roadmap.md`](todo/milestone_25_roadmap.md)
...
Milestone details are extracted to:
- [`docs/todo/milestone_26_std.md`](todo/milestone_26_std.md)

Top-level status:
- [x] 26.0 Std scope and governance [Std Gate A]
- [ ] 26.1 Std implementation and release gates [Std Gate B]
- [ ] 26.2 Finite-set proof roadmap [Std Gate C]
