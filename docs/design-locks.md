# ClearLang Design Locks Index

This document tracks the current design-lock references.

## General
- Phase design docs are in `docs/design/`.

## Phase 20-24 Milestone Design Root
- `docs/design/phase-20.0-std-packaging-runtime-linking.md`

## Milestone 3 Release-Assurance Design Locks
...
- `docs/design/phase-30.2.4-reentrancy-security-claim-lock.md`
