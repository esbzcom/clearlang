...
Reference contract: `contracts/attestation/AttestationRegistry.sol`.
...
5) Register on-chain: `register(attestation_id, payload_hash, uri)`.
6) Verifier:
