...
| Runtime worker safety limits | deterministic fuel + memory limits and crash handling under test runner | fuel/memory/crash paths remain fail-closed and map to deterministic `C138` runtime reasons |
